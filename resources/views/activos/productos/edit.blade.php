<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Editar producto') }}</h2>
                ...
                <form method="POST" action="{{ route('productos.update', $producto) }}">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input id="codigo" name="codigo" value="{{ old('codigo', $producto->codigo) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <div>
                            ...
                            <input id="nombre" name="nombre" value="{{ old('nombre', $producto->nombre) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <div>
                            ...
                            <input id="marca" name="marca" value="{{ old('marca', $producto->marca) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <div>
                            ...
                            <input id="modelo" name="modelo" value="{{ old('modelo', $producto->modelo) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    ...
                    <div class="mt-6 flex gap-3">
                        ...
                        <a href="{{ route('productos.show', $producto) }}" class="px-4 py-2 text-gray-600 hover:text-gray-900">{{ __('Ver') }}</a>
                    </div>
                </form>
            </div>
        </div>
