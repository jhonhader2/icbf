<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Importar All Users (Personas)') }}</h2></x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6" x-data="{ importing: false }">
                <p class="mb-4">Sube el archivo <strong>All Users.xlsx</strong> (hoja "All Users", encabezados en fila 7). Se importarán todas las personas; documento = Employee ID, department (3FN), account_status.</p>
                <form action="{{ route('personas.import.store') }}" method="POST" enctype="multipart/form-data" @submit="importing = true">
                    @csrf
